...
![SocNetV v3.6 Data Table dock — Nodes tab showing standard columns (#, Label, Visible, Shape, Size, Color) alongside custom attribute columns (type, GDP), with live search bar and toolbar buttons: Refresh, Export CSV, Export JSON, Import CSV, Import JSON, Set property, Remove attribute, Add attribute](/data/uploads/screenshots/36/socnetv-36-F6__Data_Table_Dock_Nodes_bulk_ops-doc-only.webp)
...
![SocNetV v3.6 Data Table dock — Nodes tab showing the bulk-operation toolbar buttons (Set property, Remove attribute, Add attribute) alongside Export/Import buttons; custom attribute columns (type, GDP) visible](/data/uploads/screenshots/36/socnetv-36-F6__Data_Table_Dock_Nodes_bulk_ops-doc-only.webp)
...
![SocNetV v3.6 Bulk Edit dialog (Nodes scope) — property combo open showing Label, Size, Color, Shape, and custom attribute keys (GDP); value field below adapts to the chosen property type](/data/uploads/screenshots/36/socnetv-36-F7__Bulk_Edit_dialog_nodes.webp)
