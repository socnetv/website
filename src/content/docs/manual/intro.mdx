...
1. **Graph Construction**  
   ...
   See more in the [Random Networks](./generate#random-network-creation) section.
...
2. **Metrics Computation**  
   ...
   See details in the [Cohesion Metrics](./analysis#cohesion-measures) section.
...
3. **Structural Statistics**  
   ...
   - PageRank prestige  
   Explore these metrics in the [Centralities](./analysis#centralities-and-prestige) section.

4. **Community Detection**  
   Use fast algorithms for detecting communities, including:
   - Triad census
   - Clique census  
   Learn more in the [Communities](./analysis#community-detection) section.

5. **Structural Equivalence Analysis**  
   Perform hierarchical clustering, actor similarity, and tie profile dissimilarity analysis.  
   See more in [Structural Equivalence](./analysis#structural-equivalence-methods).
...
6. **Visualization Models**  
   ...
   Learn more in the [Visualization](./visualization) section.
