...
- Non-destructive [graph exploration filters](/manual/gui/#filtering-and-graph-exploration): ego network, focus on selection, filter by attribute, filter by centrality, and edge weight filter — all with a persistent [filter bar](/manual/gui/#filter-bar) showing active conditions as chips.
...
- [Data Table dock](/manual/data/#data-table-dock) (`Ctrl+T`): browse, search, sort, and inline-edit all node and edge data in a live tabular view.
